...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lsMonHoc =(ListView)findViewById(R.id.ListViewSubject);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(inputValue)){
                    ...
                    Toast.makeText(
                            MainActivity.this, "Subject Not Change!", Toast.LENGTH_SHORT).show();
                }else {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(inputValue)){
                    Toast.makeText(
                            MainActivity.this, "Empty! Delete failed", Toast.LENGTH_SHORT).show();
                }else {
                    arrayCourse.remove(index);
                    arrayAdapter.notifyDataSetChanged();
                    editText.setText("");
                    Toast.makeText(
                            MainActivity.this, "Delete success!", Toast.LENGTH_SHORT).show();
